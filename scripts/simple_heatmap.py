...
ax.set_xlabel('Behavioral Features (Indicator × Lag)', fontsize=12)
ax.set_ylabel('Return Horizon (weeks ahead)', fontsize=12)

plt.xticks(rotation=45, ha='right')
plt.tight_layout()

# Save
plt.savefig(output_dir / 'heatmap_final.png', dpi=300, bbox_inches='tight')
plt.savefig(output_dir / 'heatmap_final.pdf', bbox_inches='tight')

print("Heatmap saved successfully!")
print(f"PNG: {output_dir / 'heatmap_final.png'}")
print(f"PDF: {output_dir / 'heatmap_final.pdf'}")
